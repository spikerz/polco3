  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved roll as @roll" do
        ...
        post :create, {:roll => {}}, valid_session
        assigns(:roll).should be_a_new(Roll)
      end
      ...
      it "re-renders the 'new' template" do
        # Trigger the behavior that occurs when invalid params are submitted
        Roll.any_instance.stub(:save).and_return(false)
        Roll.any_instance.stub(:errors).and_return(['error'])
        post :create, {:roll => {}}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested roll" do
        ...
        Roll.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => roll.to_param, :roll => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the roll as @roll" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Roll.any_instance.stub(:save).and_return(false)
        put :update, {:id => roll.to_param, :roll => {}}, valid_session
        assigns(:roll).should eq(roll)
      end
