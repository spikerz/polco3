  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested legislator_vote" do
        ...
        LegislatorVote.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => legislator_vote.to_param, :legislator_vote => {'these' => 'params'}}, valid_session
      end
